...
@pytest.mark.parametrize(('parameter', 'str_type', 'param_value'), [
    ...
    (IP_ADDRESS, 'ip address', 'foo'),
    (IP_ADDRESS, 'ip address', '1245'),
    (IP_ADDRESS, 'ip address', '125.5'),
    # ipv4 address
    (IPV4_ADDRESS, 'ipv4 address', 'foo'),
    (IPV4_ADDRESS, 'ipv4 address', '1245'),
    (IPV4_ADDRESS, 'ipv4 address', '125.5'),
    # ipv6 address
    (IPV6_ADDRESS, 'ipv6 address', 'foo'),
    (IPV6_ADDRESS, 'ipv6 address', '1245'),
    (IPV6_ADDRESS, 'ipv6 address', '125.5'),
    # generic ip network (ipv4 or ipv6)
    (IP_NETWORK, 'ip network', 'foo'),
    (IP_NETWORK, 'ip network', '1245'),
    (IP_NETWORK, 'ip network', '1452.5'),
    (IP_NETWORK, 'ip network', '12.0.0.0/45'),
    (IP_NETWORK, 'ip network', '1245/24'),
    (IP_NETWORK, 'ip network', '2001:db00::0/ffff:ff00::'),
    # ipv4 network
    (IPV4_NETWORK, 'ipv4 network', 'foo'),
    (IPV4_NETWORK, 'ipv4 network', '1245'),
    (IPV4_NETWORK, 'ipv4 network', '1452.5'),
    (IPV4_NETWORK, 'ipv4 network', '12.0.0.0/45'),
    (IPV4_NETWORK, 'ipv4 network', '1245/24'),
    # ipv6 network
    (IPV6_NETWORK, 'ipv6 network', 'foo'),
    (IPV6_NETWORK, 'ipv6 network', '1245'),
    (IPV6_NETWORK, 'ipv6 network', '1452.5'),
    (IPV6_NETWORK, 'ipv6 network', '2001:db00::0/ffff:ff00::'),
])
